...
import { FaUpload, FaSpinner, FaHome, FaMapMarkerAlt, FaUserTie, FaEnvelope, FaDollarSign, FaExclamationTriangle, FaUserShield, FaInfoCircle } from 'react-icons/fa';
...
const AddProperty = () => {
    ...
    const mutation = useMutation({
        ...
        onError: () => {
            Swal.fire({
                icon: 'error', title: 'Error', text: 'Failed to add property', showConfirmButton: false, timer: 1500
            });
        }
    })
                ...
                agent?.isfraud ?
                    ...
                    <>
                        <div className="max-w-md mx-auto p-6 bg-white rounded-xl ">
                            ...
                            <div className="text-center p-6 border-2 border-[#fceb00] rounded-lg bg-[#f8f3b1]">
                                ...
                                <p className="text-2xl font-bold text-black mb-2 flex items-center justify-center">
                                    <FaUserShield className="mr-2" /> Account Marked as FRAUD
                                </p>
                                <p className="text-xl font-semibold text-gray-700 mb-4">
                                    You are restricted from adding properties
                                </p>
